...
<%if (request.getParameter("lat") == null) {%>
	$('#latitude').html(pos.coords.latitude); // 위도\
				...
				location.href = "readoor.jsp?lat=" + pos.coords.latitude
...
=======
		...
		<div class="jumbotron">
			<div class="container" id="search_bar">
				...
				<div class="input-group">
					<span class="input-group-btn">
						<form action="/team/search4" method="get">
							<input type="text" placeholder="책 검색" class="form-control"
								id=title name=booktitle > <input type="hidden"
								name="latitude" value=<%=lati%>> <input type="hidden"
								name="longitude" value=<%=longi%>>
							<button type="submit" class="btn btn-search" id="searchBtn">Search</button>
						</form>
					</span>
				</div>
			</div>
	...
	<section class="team-sec" id="team">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 text-center member-block">
					<img class="up-effect" src="img/team-member-02.png">
					<h3 class="up-effect">김희영</h3>
					<div class="contact-con down-effect">
						<i class="fa fa-phone fa-2x"></i><i class="fa fa-envelope-o fa-2x"></i><i
							class="fa fa-heart-o fa-2x"></i>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 text-center member-block">
					<img class="up-effect" src="img/team-member-02.png">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 text-center member-block">
					<img class="up-effect" src="img/team-member-01.png">
					<h3 class="up-effect">이윤지</h3>
					<div class="contact-con down-effect">
						<i class="fa fa-phone fa-2x"></i><i class="fa fa-envelope-o fa-2x"></i><i
							class="fa fa-heart-o fa-2x"></i>
	...
	<script>
		$(window).scroll(function() {
			var sticky = $('.navbar-brand'), scroll = $(window).scrollTop();
